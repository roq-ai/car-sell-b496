  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Car Sell - Empowering Your Automotive Journey. Buy, Sell, and Discover Cars Like Never Before. Your Dream Car is Just a Click Away."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1492144534655-ae79c964c9d7?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxjYXJzfGVufDB8fHx8MTY5NzA1MDU5NHww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@peterbroomfield?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Peter Broomfield`}</Link>{' '}
              on{' '}
              <Link
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Car Sell - Empowering Your Automotive Journey. Buy, Sell, and Discover Cars Like Never Before. Your Dream Car is Just a Click Away.`}
            </Text>
            <Box
