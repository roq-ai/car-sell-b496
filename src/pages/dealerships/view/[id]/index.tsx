...
import { SalesManagerListPage } from 'pages/sales-managers';
import { SalesRepresentativeListPage } from 'pages/sales-representatives';
            ...
            <FormWrapper wrapperProps={{ gap: 3, p: 4 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('dealership', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/dealerships/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              <EntityImage entity="dealership" entityId={id} />
              <List
                w="100%"
                css={{
                  '> li:not(:last-child)': {
