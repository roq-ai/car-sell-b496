...
import { getSalesRepresentativeById } from 'apiSdk/sales-representatives';
import { SalesRepresentativeInterface } from 'interfaces/sales-representative';

function SalesRepresentativeViewPage() {
      ...
      breadcrumbs={
        <Breadcrumbs
          items={[
            ...
            {
              label: 'Sales Representative Details',
              isCurrent: true,
            },
          ]}
        />
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('sales_representative', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/sales-representatives/edit/${id}`} passHref legacyBehavior>
                    <Button
